...
$sql=mysqli_query($con,"update  products set category='$category',productName='$productname',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability' where id='$pid' ");
...
<head>
	...
	<title> TS Admin| Insert Product</title>
